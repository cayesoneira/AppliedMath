function [x,phi,i]=diffincNoLinealN_evol(l,u,v,w,p,a,b,alfa,beta,num_pas,iopc,gamma,delta,tol,maxit)
...
vN=@(t) p*feval(v,t).*phi0.^(p-1)+feval(l,t);
uN=@(t) feval(u,t)+(1-p)*feval(v,t).*phi0.^p;
